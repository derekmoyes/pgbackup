...
def test_dump_file_name_with_timestamp():
  """
  pgdump.dump_file_name returns the name of the database with 
  timestamp appended.
  """
  timestamp = "1971-02-27T13-14"
  assert pgdump.dump_file_name(url, timestamp) == "db_one-1971-02-27T13-14.sql"
